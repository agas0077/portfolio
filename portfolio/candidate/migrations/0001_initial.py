    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='user_image/', verbose_name='Фотография')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skills', to='candidate.candidate')),
            ],
        ),
        migrations.CreateModel(
            name='Recomendation',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recomendations', to='candidate.candidate')),
            ],
        ),
        migrations.CreateModel(
            name='Language',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='languages', to='candidate.candidate')),
            ],
        ),
        migrations.CreateModel(
            name='Job',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='candidate.candidate')),
            ],
            options={
                'ordering': ('-date_from',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='educations', to='candidate.candidate')),
            ],
        ),
    ]
